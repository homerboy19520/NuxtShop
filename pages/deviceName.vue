<template>
  <div class="device-name">
    ...
    <div class="device-name__wrapper">
      <HeroApp
        class="device-name__hero"
        :data="MAIN_DATA.deviceNameContent.hero"
      ></HeroApp>
      <SwiperModal
        modifier="device"
        class="device-name__swiper main__container"
        :data="MAIN_DATA.swiperBreaking"
      ></SwiperModal>
      <BreakingModal
        class="device-name__breaking main__container"
      ...
      <div class="main__container">
        <FormModal
          class="device-name__form-modal"
          :data="MAIN_DATA.formContent.firstModal"
        ></FormModal>
        <GridModal class="device-name__grid"></GridModal>
        <CalcModal class="device-name__calc"></CalcModal>
      </div>
      ...
      <div class="main__container">
        ...
        <SpoilerModal
          class="device-name__spoiler"
          :data="MAIN_DATA.spoilerContent"
        ></SpoilerModal>
        <SchemeModal class="device-name__scheme"></SchemeModal>
        <FormModal
          class="device-name__form-modal second"
