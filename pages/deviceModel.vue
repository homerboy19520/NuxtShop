<template>
  <div class="device-model">
    ...
    <div class="device-model__wrapper">
      <HeroApp
        class="device-model__hero"
        :data="MAIN_DATA.deviceModel.hero"
      ></HeroApp>
      <SwiperModal
        modifier="device"
        class="device-model__swiper main__container"
        :data="MAIN_DATA.swiperBreaking"
      ></SwiperModal>
      <BreakingModal
        class="device-model__breaking main__container"
        :data="MAIN_DATA.breakingContent"
      ></BreakingModal>
      <SwiperModal
        modifier="models"
        class="device-model__swiper main__container"
        :data="MAIN_DATA.swiperModelsPage"
      ></SwiperModal>
      <div class="main__container">
        <FormModal
          class="device-model__form-modal"
          :data="MAIN_DATA.formContent.modelForm"
        ></FormModal>
        <GridModal class="device-model__grid"></GridModal>
        <CalcModal class="device-model__calc"></CalcModal>
      </div>
      ...
      <div class="main__container">
        ...
        <SpoilerModal
          class="device-model__spoiler"
          :data="MAIN_DATA.spoilerContent"
        ></SpoilerModal>
        <SchemeModal class="device-model__scheme"></SchemeModal>
        <FormModal
          class="device-model__form-modal second"
